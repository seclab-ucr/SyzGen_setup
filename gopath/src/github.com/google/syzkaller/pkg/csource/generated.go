...
#if GOOS_darwin
DARWIN_INCLUDE <stdio.h>
DARWIN_INCLUDE <stdlib.h>
DARWIN_INCLUDE <string.h>
DARWIN_INCLUDE <sys/mman.h>
DARWIN_INCLUDE <mach/mach.h>
DARWIN_INCLUDE <IOKit/IOKitLib.h>
DARWIN_INCLUDE <libkern/OSByteOrder.h>
...
static long syz_IOConnectCallMethod(volatile long arg0, volatile long arg1, volatile long arg2, volatile long arg3,
		...
		volatile long arg9) {
	return IOConnectCallMethod((mach_port_t) arg0, (uint32) arg1,
...
static long syz_IOConnectCallAsyncMethod(volatile long arg0, volatile long arg1, volatile long arg2, volatile long arg3,
	...
	return IOConnectCallAsyncMethod((mach_port_t) arg0, (uint32) arg1,
...
#if GOOS_darwin
DARWIN_INCLUDE <signal.h>
DARWIN_INCLUDE <sys/types.h>
DARWIN_INCLUDE <sys/types.h>
#endif
...
#if GOOS_darwin
DARWIN_INCLUDE <errno.h>
DARWIN_INCLUDE <pthread.h>
#endif
...
#if GOOS_freebsd || GOOS_netbsd || GOOS_openbsd || GOOS_akaros || GOOS_test || GOOS_darwin
#if SYZ_EXECUTOR || SYZ_THREADED
